...
<div class="container">
    ...
    <div class="row">
      <div class="col-md-6">
        <img src="<?php echo $product['product_image']  ?>" class="w-100" alt="">
      ...
      <div class="col-md-6">
        <div class="product-dtl">
          <div class="product-info">
            ...
            <div class="product-price-discount"><span><?php echo $product['product_price']  ?></span><span class="line-through">$29.00</span></div>
          </div>
    ...
    <div class="product-info-tabs">
      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
          ...
          <p class="mb-20"><h3>user:</h3>Tốt</p>
